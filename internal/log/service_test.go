...
func TestLogService_LogChore_Basic(t *testing.T) {
	...
	l, err := svc.LogChore(ctx, 1, 10, 100, "done", nil, nil, nil, nil, nil, nil)
	if err != nil {
...
func TestLogService_LogChore_WithCompletedAt(t *testing.T) {
	...
	l, err := svc.LogChore(ctx, 1, 10, 100, "", nil, nil, nil, nil, &ts, nil)
	if err != nil {
		t.Fatalf("LogChore: %v", err)
	}
...
func TestLogService_LogChore_WithDate_NoCompletedAt(t *testing.T) {
	...
	l, err := svc.LogChore(ctx, 1, 10, 100, "", nil, nil, &d, nil, nil, nil)
	if err != nil {
		t.Fatalf("LogChore: %v", err)
	}
...
func TestLogService_LogChore_WithSlotHour(t *testing.T) {
	...
	hour := 8
	l, err := svc.LogChore(ctx, 1, 10, 100, "", nil, nil, nil, &hour, nil, nil)
	if err != nil {
		t.Fatalf("LogChore: %v", err)
	}
...
func TestLogService_LogChore_WithVolumeML(t *testing.T) {
	...
	vol := 150
	l, err := svc.LogChore(ctx, 1, 10, 100, "", nil, nil, nil, nil, nil, &vol)
	if err != nil {
		t.Fatalf("LogChore: %v", err)
	}
...
func TestLogService_LogChore_WithIndicatorVolumes(t *testing.T) {
	...
	l, err := svc.LogChore(ctx, 1, 10, 100, "", []string{"🍼 formula", "🤱 breast"}, iv, nil, nil, nil, nil)
	if err != nil {
		t.Fatalf("LogChore: %v", err)
	}
...
func TestLogService_UpdateLog(t *testing.T) {
	...
	l, _ := svc.LogChore(ctx, 1, 10, 100, "original", []string{"a"}, nil, nil, nil, nil, nil)
	...
	err := svc.UpdateLog(ctx, l.ID, 1, "updated", []string{"b", "c"}, iv, &vol, &newUID, &newTime, &hour, &logDate)
	if err != nil {
...
func TestLogService_UpdateLog_NotFound(t *testing.T) {
	svc := chorelog.NewService(chorelog.NewMemoryStore())
	err := svc.UpdateLog(context.Background(), 9999, 1, "", nil, nil, nil, nil, nil, nil, nil)
	if err == nil {
...
func TestLogService_UndoLog(t *testing.T) {
	...
	l, _ := svc.LogChore(ctx, 1, 10, 100, "", nil, nil, nil, nil, nil, nil)
...
func TestLogService_GetTodayLogs(t *testing.T) {
	...
	_, _ = svc.LogChore(ctx, 1, 10, 100, "", nil, nil, nil, nil, nil, nil)
	_, _ = svc.LogChore(ctx, 1, 10, 101, "", nil, nil, nil, nil, nil, nil)
...
func TestLogService_GetDayLogs(t *testing.T) {
	...
	_, _ = svc.LogChore(ctx, 1, 10, 100, "", nil, nil, &day1, nil, nil, nil)
	_, _ = svc.LogChore(ctx, 1, 10, 101, "", nil, nil, &day2, nil, nil, nil)
...
func TestLogService_GetWeekLogs(t *testing.T) {
	...
	_, _ = svc.LogChore(ctx, 1, 10, 100, "", nil, nil, &inRange, nil, nil, nil)
	_, _ = svc.LogChore(ctx, 1, 10, 101, "", nil, nil, &outRange, nil, nil, nil)
...
func TestLogService_GetMonthLogs(t *testing.T) {
	...
	_, _ = svc.LogChore(ctx, 1, 10, 100, "", nil, nil, &apr, nil, nil, nil)
	_, _ = svc.LogChore(ctx, 1, 10, 101, "", nil, nil, &may, nil, nil, nil)
...
func TestLogService_GetDailySummary(t *testing.T) {
	...
	_, _ = svc.LogChore(ctx, 1, 10, 100, "", nil, nil, &day, nil, nil, nil)
	_, _ = svc.LogChore(ctx, 1, 11, 101, "", nil, nil, &day, nil, nil, nil)
...
func TestLogService_LatestPerChore(t *testing.T) {
	...
	_, _ = svc.LogChore(ctx, 1, 10, 100, "old", nil, nil, &earlier, nil, &earlier, nil)
	_, _ = svc.LogChore(ctx, 1, 10, 100, "new", nil, nil, &later, nil, &later, nil)
	_, _ = svc.LogChore(ctx, 1, 10, 200, "only", nil, nil, &later, nil, &later, nil)
...
func TestLogService_GetHistoryLogs(t *testing.T) {
	...
	_, _ = svc.LogChore(ctx, 1, 10, 100, "old", nil, nil, &old, nil, &old, nil)
	_, _ = svc.LogChore(ctx, 1, 10, 101, "mid", nil, nil, &mid, nil, &mid, nil)
	_, _ = svc.LogChore(ctx, 1, 10, 102, "recent", nil, nil, &recent, nil, &recent, nil)
...
func TestLogService_UpdateLog_NilIndicators(t *testing.T) {
	...
	l, _ := svc.LogChore(ctx, 1, 10, 100, "original", []string{"a"}, nil, nil, nil, nil, nil)
	err := svc.UpdateLog(ctx, l.ID, 1, "updated", nil, nil, nil, nil, nil, nil, nil)
	if err != nil {
...
func TestLogService_GetHistoryLogs_NoMore(t *testing.T) {
	...
	_, _ = svc.LogChore(ctx, 1, 10, 100, "", nil, nil, &d, nil, &d, nil)
