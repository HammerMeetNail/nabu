...
func TestService_CreateChore_Basic(t *testing.T) {
	...
	c, err := svc.CreateChore(ctx, 1, 10, "Wash Dishes", "🍽️", "#3B82F6", "cleaning", nil)
	if err != nil {
...
func TestService_CreateChore_Defaults(t *testing.T) {
	...
	c, err := svc.CreateChore(ctx, 1, 10, "My Chore", "", "", "", nil)
	if err != nil {
		t.Fatalf("CreateChore: %v", err)
	}
	if c.Icon == "" {
...
func TestService_CreateChore_EmptyNameError(t *testing.T) {
	svc := chore.NewService(chore.NewMemoryStore())
	_, err := svc.CreateChore(context.Background(), 1, 10, "", "", "", "", nil)
	if err == nil {
...
func TestService_GetChore(t *testing.T) {
	...
	created, _ := svc.CreateChore(ctx, 1, 10, "Cat Feeding", "🐱", "", "", nil)
...
func TestService_UpdateChore_PartialUpdate(t *testing.T) {
	...
	c, _ := svc.CreateChore(ctx, 1, 10, "Old Name", "🐱", "#000", "cleaning", nil)

	err := svc.UpdateChore(ctx, c.ID, "New Name", "", "", "", nil)
	if err != nil {
...
func TestService_UpdateChore_UpdateIndicators(t *testing.T) {
	...
	c, _ := svc.CreateChore(ctx, 1, 10, "Task", "", "", "", []string{"label1"})
	err := svc.UpdateChore(ctx, c.ID, "", "", "", "", []string{"new1", "new2"})
	if err != nil {
		t.Fatalf("UpdateChore: %v", err)
	}
	updated, _ := svc.GetChore(ctx, c.ID)
...
func TestService_UpdateChore_NotFound(t *testing.T) {
	svc := chore.NewService(chore.NewMemoryStore())
	err := svc.UpdateChore(context.Background(), 9999, "X", "", "", "", nil)
	if err == nil {
		t.Fatal("expected error for missing chore")
	}
}
...
func TestService_DeleteChore(t *testing.T) {
	...
	c, _ := svc.CreateChore(ctx, 1, 10, "Temp", "", "", "", nil)
	err := svc.DeleteChore(ctx, c.ID)
	if err != nil {
...
func TestService_DeleteChore_Predefined(t *testing.T) {
	...
	err := svc.DeleteChore(ctx, predefined.ID)
	if err == nil {
...
func TestService_DeleteChore_NotFound(t *testing.T) {
	svc := chore.NewService(chore.NewMemoryStore())
	err := svc.DeleteChore(context.Background(), 9999)
	if err == nil {
		t.Fatal("expected error for missing chore")
	}
}
...
func TestService_ReorderChores(t *testing.T) {
	...
	c1, _ := svc.CreateChore(ctx, 1, 10, "A", "", "", "", nil)
	c2, _ := svc.CreateChore(ctx, 1, 10, "B", "", "", "", nil)
	c3, _ := svc.CreateChore(ctx, 1, 10, "C", "", "", "", nil)
...
func TestService_RestoreDefaultChore_NotPredefined(t *testing.T) {
	...
	c, _ := svc.CreateChore(ctx, 1, 10, "Custom", "", "", "", nil)
	err := svc.RestoreDefaultChore(ctx, c.ID)
	if err == nil {
...
func TestService_RestoreDefaultChore_NotFound(t *testing.T) {
	svc := chore.NewService(chore.NewMemoryStore())
	err := svc.RestoreDefaultChore(context.Background(), 9999)
	if err == nil {
		t.Fatal("expected error for missing chore")
	}
}
...
func TestService_UpdateChore_WithIconColorCategory(t *testing.T) {
	...
	c, _ := svc.CreateChore(ctx, 1, 10, "Sweep", "🧹", "#000", "cleaning", nil)

	// Pass non-empty icon, color, and category – covers all three update branches
	err := svc.UpdateChore(ctx, c.ID, "", "🫧", "#AABBCC", "hygiene", nil)
	if err != nil {
		t.Fatalf("UpdateChore: %v", err)
	}
