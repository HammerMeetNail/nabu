    ...
    (
        ...
        FROM (
            ...
            FROM (
                ...
                LEFT JOIN _cat_pumpkin_updates updates
...
USING _cat_pumpkin_updates updates
...
DROP TABLE _cat_pumpkin_updates;
